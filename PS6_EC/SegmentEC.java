 ...
 */
public class SegmentEC implements ShapeEC {
	 ...
	 */
	public SegmentEC(int x1, int y1, Color color) {
	 ...
	 */
	public SegmentEC(int x1, int y1, int x2, int y2, Color color) {
	...
	public boolean contains(int x, int y) {
		return pointToSegmentDistance(x, y, x1, y1, x2, y2) <= 10;
	}
